...
//---------------------------------------------------------------------------------------------------
// Create simple machine hoac source machine
if ($machine_type == 'simplemachine' || $machine_type == 'sourcemachine'){
    $x=0;

    // check xem VM do da ton tai chua
    ...
    while ($x < $machinecount){
        ...
        // tao password radom cho SPICE html5
...
if ($machine_type == 'initialmachine'){
    ...
    //---------------------------------
    //copy file disk tu source machine sang initial machine
...
if ($machine_type == 'vdimachine'){
    ...
    //------------------------------------------
    // Copy file disk tu source machine sang VDI machine
